...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name greatsql-operator-builder
	$(CONTAINER_TOOL) buildx use greatsql-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --provenance=false --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm greatsql-operator-builder
	rm Dockerfile.cross
...
.PHONY: helm-package
helm-package: ## Package dist/chart into a .tgz in dist/
