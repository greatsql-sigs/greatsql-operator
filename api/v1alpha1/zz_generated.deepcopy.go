...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SchedulingBuckup) DeepCopyInto(out *SchedulingBuckup) {
	*out = *in
	if in.Enable != nil {
		in, out := &in.Enable, &out.Enable
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchedulingBuckup.
func (in *SchedulingBuckup) DeepCopy() *SchedulingBuckup {
	if in == nil {
		return nil
	}
	out := new(SchedulingBuckup)
	in.DeepCopyInto(out)
	return out
}
